...
class NodeTool extends BaseTool {
    ...
    onPointerMove(world) { this.app.canvas.requestRedraw(); }
...
class PanTool extends BaseTool {
    onPointerDown(_world, screen) { this.panning = true; this.lastScreen = screen; }
...
export class ToolManager {
    ...
    getActiveName() { return Object.keys(this.tools).find((key) => this.tools[key] === this.active) ?? null; }
